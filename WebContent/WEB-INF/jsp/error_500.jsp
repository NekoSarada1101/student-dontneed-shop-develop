...
<h1 class="text-center mt-5">500</h1>
<p class="text-center">予期しないエラー</p>

<div class="text-center row">
    <form action="memberLogout" method="get" class="col-6 text-right">
        <button class="btn btn-outline-primary">会員画面へ</button>
    </form>

    <form action="adminLogout" method="get" class="col-6 text-left">
        <button class="btn btn-outline-success">管理者画面へ</button>
    </form>
</div>

<div class="col-12 col-md-10 mx-auto text-center mt-5">
    <img src="img/sorry.png" alt="" class="img-fluid">
</div>
